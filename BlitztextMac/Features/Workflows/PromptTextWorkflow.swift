...
@Observable
@MainActor
final class PromptTextWorkflow: Workflow {
    let type = WorkflowType.promptText
    ...
    private let settings: PromptTextSettings
    private let customTerms: [String]
    private let language: String
    private var processingTask: Task<Void, Never>?

    init(settings: PromptTextSettings, customTerms: [String] = [], language: String = "de") {
    ...
    // MARK: - Two-Phase Processing: Whisper -> Prompt
    ...
    private func processRecording() {
        ...
        processingTask = Task {
            ...
            do {
                ...
                phase = .running("Prompt wird formuliert ...")

                let result = try await LLMService.craftPrompt(
                    text: cleanedRawText,
                    settings: settings,
